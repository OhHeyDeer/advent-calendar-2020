...
const findNums = (data) => {
    for(let i = 0; i < data.length; i++) {
        for (let j = 0; j < data.length; j++) {
            ...
            if (Number.parseInt(data[j]) + Number.parseInt(data[i]) === 2020) {
                return Number.parseInt(data[j]) * Number.parseInt(data[i]);
            }
        }
    }
}

console.log(findNums(newData));

// Part 2

// Find the three numbers that add to 2020 and return their product
const findThreeNums = (data) => {
    ...
    for(let i = 0; i < data.length; i++) {
        for (let j = 0; j < data.length; j++) {
            ...
            for (let k = 0; k < data.length; k++) {
                if (data[k] === data[j] || data[k] === data[i]) {
                    continue;
                }

                if (Number.parseInt(data[j]) + Number.parseInt(data[i]) + Number.parseInt(data[k]) === 2020) {
                    return Number.parseInt(data[j]) * Number.parseInt(data[i]) * Number.parseInt(data[k]);
                }
            }
...
console.log(findThreeNums(newData));